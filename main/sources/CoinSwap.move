module Sender::CoinSwap {
    ...
    public(script) fun create_pool<CoinType1: drop, CoinType2: drop>(coinswap: signer, requester: signer, coin1: u64, coin2: u64, share: u64) {
    ...
    public(script) fun swap<CoinType1: drop, CoinType2: drop>(coinswap: signer, requester: signer, coin1: u64) acquires LiquidityPool {
